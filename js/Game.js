...
var obstacles2Positions = [ { x: width / 2 + 250, y: height - 800, image: obstacle2Image }, 
  ...
  { x: width / 2 - 180, y: height - 5500, image: obstacle2Image }, ];
    ...
    this.addSprites(obstacle1,obstacles1Positions.length,obstacle1Image,0.04,obstacles1Positions);
    this.addSprites(obstacle2,obstacles2Positions.length,obstacle2Image,0.04,obstacles2Positions);
...
gameOver(){
  swal({ 
   title: `você perdeu`,
    text: "parabens você foi bom o suficiente para perder",
   imageUrl: "https://cdn.shopify.com/s/files/1/1061/1924/products/Thumbs_Down_Sign_Emoji_Icon_ios10_grande.png",
   imageSize: "100x100",
   confirmButtonText: "vai embora 0:<" });
}
